 ...
 const experiences: ExperienceItem[] = [
  {
    ...
    responsibilities: [
      "Participer à la conception, la réhabilitation et la réfection de ponts et ouvrages d’art (structures routières et ferroviaires)",
      "Réaliser la modélisation, l’analyse et les calculs de conception pour les ponts et autres structures avec les logiciels CSI Bridges, Advanced Design America, etc. (2D et 3D ou éléments finis);",
      "Élaborer les notes de calcul et rédiger les études de faisabilité",
      "Participer aux études d'évaluations de la capacité portante des ouvrages",
      "Participer à des réunions et discussions techniques, et élaborer des solutions à des problèmes techniques complexes ou uniques",
      "Orienter les dessinateurs et préparer devis, plans et rapports selon les attentes du client",
      "Assister les clients en période d'appel d'offre et en phase réalisation",
    ],
    achievements: [
  ...
  },
  {
    ...
    responsibilities: [
      "Contribuer à la construction du SIG des lignes souterraines d'Hydro-Québec",
      ...
      "Contribuer à la réalisation et l'implantation d'un logiciel interne pour la gestion des listes de matériels",
    ],
    achievements: [],
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Rédiger les rapports jouraliers",
